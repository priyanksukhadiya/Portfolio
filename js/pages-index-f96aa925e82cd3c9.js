        ...
        7211: function (e, t, a) {
                ...
                return (0, s.jsxs)("div", {
                    children: [
                        (0, s.jsxs)("p", {
                            className: "mb-4",
                            children: [
                                "My journey into web development began with a transformative internship from January to June 2023, where I delved into WordPress customization and plugin development. This experience ignited my passion for creating seamless user experiences through PHP programming, HTML, CSS, and JavaScript. Armed with these skills, I transitioned into a full-fledged WordPress Developer in July 2023.",
                        ...
                        (0, s.jsxs)("p", {
                            className: "mb-4",
                            children: [
                                "In my current role, I specialize in integrating designs into functional websites while enhancing site performance and ensuring robust security measures. Collaborating closely with cross-functional teams, I prioritize delivering websites that are not only visually appealing but also aligned with business objectives and SEO best practices.",
                            ],
                        }),
                        (0, s.jsxs)("p", {
                            children: [
                                "Before specializing in web development, I earned a Master of Computer Application at Ganpat University, participating in the SSIP: Aazadi ka Amrit Mahotsav Hackathon of 2022. My academic journey also includes a Bachelor of Commerce degree from Shri S.S. Mehta Arts and M.M. Patel Commerce College, where I developed a strong foundation in accounts, business management, and economics.",
                            ],
                        }),
                    ],
                });
                            ...
                            children: [
                                {
                                    ...
                                    company: { name: "Alakmalak Technologies", link: "#" },
                                    positions: ["WordPress Developer"],
                                    desc:
                                        "Proficient in WordPress theme integration, adeptly merging designs into functional websites and creating custom solutions to enhance site performance. Responsible for developing, maintaining, and optimizing WordPress-based websites with a strong focus on security. Collaborate closely with teams to ensure delivered sites are functional, visually appealing, and aligned with business goals and SEO best practices.",
                                    tech: ["WordPress", "Javascript", "HTML/CSS", "PHP"],
                                },
                                {
                                    date: "January 2023 — June 2023",
                                    company: { name: "Alakmalak Technologies", link: "#" },
                                    positions: ["WordPress Internship"],
                                    desc:
                                        "As a WordPress intern, gained hands-on experience in customizing themes, developing plugins, and optimizing website performance. Acquired essential skills in PHP programming, frontend development with HTML, CSS, and JavaScript, and effective use of WordPress CMS. Passionate about creating user-friendly and visually appealing websites while adhering to best practices in web development.",
                                    tech: ["WordPress", "JavaScript", "HTML & SCSS", "PHP"],
                                },
                            ].map((e, t) =>
                                (0, s.jsx)(
                                    "li",
                ...
                return (0, s.jsx)("footer", {
                    ...
                    children: (0, s.jsxs)("p", {
                        children: [
                            "Loosely designed in",
                            " ",
                            (0, s.jsx)("a", { href: "https://www.figma.com/", className: e, target: "_blank", rel: "noreferrer noopener", "aria-label": "Figma (opens in a new tab)", children: "Figma" }),
                            " ",
                            "and coded in",
                            " ",
                            (0, s.jsx)("a", { href: "https://code.visualstudio.com/", className: e, target: "_blank", rel: "noreferrer noopener", "aria-label": "Visual Studio Code (opens in a new tab)", children: "Visual Studio Code" }),
                            " ",
                            ...
                            "and",
                            " ",
                            (0, s.jsx)("a", { href: "https://tailwindcss.com/", className: e, target: "_blank", rel: "noreferrer noopener", "aria-label": "Tailwind CSS (opens in a new tab)", children: "Tailwind CSS" }),
                            ", deployed with",
                            " ",
                            (0, s.jsx)("a", { href: "https://vercel.com/", className: e, target: "_blank", rel: "noreferrer noopener", "aria-label": "Vercel (opens in a new tab)", children: "Vercel" }),
                            ". All text is set in the",
                            " ",
                            (0, s.jsx)("a", { href: "https://rsms.me/inter/", className: e, target: "_blank", rel: "noreferrer noopener", "aria-label": "Inter (opens in a new tab)", children: "Inter" }),
                            " ",
                            "typeface.",
                        ],
                    }),
            ...
            function u(e) {
                ...
                return (0, s.jsxs)("header", {
                    ...
                    children: [
                        (0, s.jsxs)("div", {
                            children: [
                                (0, s.jsx)("h1", { className: "text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl", children: (0, s.jsx)(h(), { href: "/", children: "Priyank Sukhadiya" }) }),
                                (0, s.jsx)("h2", { className: "mt-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl", children: "WordPress Developer" }),
                                (0, s.jsx)("p", { className: "mt-4 max-w-xs leading-normal", children: "I specialize in crafting pixel-perfect, engaging, and accessible digital experiences through WordPress development." }),
                                (0, s.jsx)("nav", {
            ...
            function b() {
                ...
                return (0, s.jsxs)("div", {
                    children: [
                        ...
                        (0, s.jsx)("div", { className: "mt-12", children: (0, s.jsx)(f, { title: "View Full Project Archive", url: "/archive", className: "font-semibold text-slate-200" }) }),
                    ],
                });
            }
            var v = a(8425),
                            ...
                            (0, s.jsxs)(w.h_, {
                                ...
                                children: [
                                    (0, s.jsx)(w.aV, {
                                        ...
                                        children: (0, s.jsxs)("div", { className: "portal-inner", children: [(0, s.jsx)("div", {}), (0, s.jsx)("div", {}), (0, s.jsx)("div", {}), (0, s.jsx)("div", {}), (0, s.jsx)("div", {})] }),
                                    }),
                                    (0, s.jsxs)(w.VY, {
                                                                            ...
                                                                            children: (0, s.jsxs)("a", {
                                                                                ...
                                                                                children: [
                                                                                    ...
                                                                                    (0, s.jsx)("div", {
                                                                                        ...
                                                                                        children: (0, s.jsx)("h3", { className: "not-sr-only text-xl font-semibold text-white", children: e.title }),
                                                                                    }),
                                                                                ],
                                                                            }),
                                                                        },
                                    ...
                                    children: (0, s.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            (0, s.jsxs)("div", {
                                                ...
                                                children: [
                                                    (0, s.jsx)("p", { className: "-mt-1 text-sm font-semibold leading-6", children: e.date }),
                                                    (0, s.jsx)("h3", { className: "-mt-1", children: (0, s.jsx)(l.Z, { title: e.title, url: e.url, fill: !0 }) }),
                                                ],
                                            }),
                                        ],
                                    }),
            ...
            function k() {
                ...
                let t = [
                    ...
                    { heading: "Writing", label: "Blog posts", component: (0, s.jsx)(y, {}), hideFromNav: !0 },
                ];
                return (0, s.jsxs)("div", {
                    className: "lg:flex lg:justify-between lg:gap-4",
                    children: [
                        (0, s.jsx)(v.Z, { pathname: "/", title: "Priyank Sukhadiya" }),
